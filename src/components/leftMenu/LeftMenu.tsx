...
const LeftMenu = ({ type }: { type: "home" | "profile" }) => {
  return (
    <div className="flex flex-col gap-6 ">
      ...
      <div className="p-4 bg-white rounded-lg shadow-md text-sm font-medium text-gray-700 flex flex-col gap-2 hover:shadow-red-300">
        <Link
          href=""
          className="flex items-center gap-4 p-2 rounded-lg hover:bg-slate-100 cursor-default"
        >
